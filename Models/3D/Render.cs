    ...
    public class Renderer : OpenGlControlBase, IGraphicsHost<GL>
    {
        ...
        protected override void OnOpenGlInit(GlInterface gl)
        {
            ...
            // Initialize the OpenGL context
            {
                ...
                using Shader vs = new(this, ShaderType.VertexShader, File.ReadAllText("Resources/Shaders/Canvas.vert"));
                using Shader fs = new(this, ShaderType.FragmentShader, File.ReadAllText("Resources/Shaders/Canvas.frag"));
        ...
        protected override void OnOpenGlDeinit(GlInterface gl)
        {
            ...
            foreach (Figure mesh in canvasMeshes!)
            {
                mesh.Dispose();
            }
